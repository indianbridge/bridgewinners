...
c:{name:"Clubs",index:3,html:'<font color="000000">&clubs;</font>'}},suitOrder:[],calls:{n:{name:"No Trump",index:0,isStrain:!0,bid:!0,text:"NT",html:'<font color="000000">NT</font>'},s:{name:"Spades",index:1,isStrain:!0,bid:!0,text:"&spades;",html:'<font color="000000">&spades;</font>'},h:{name:"Hearts",index:2,isStrain:!0,bid:!0,text:"&hearts;",html:'<font color="CB0000">&hearts;</font>'},d:{name:"Diamonds",index:3,isStrain:!0,bid:!0,text:"&diams;",html:'<font color="CB0000">&diams;</font>'},c:{name:"Clubs",
index:4,isStrain:!0,bid:!0,text:"&clubs;",html:'<font color="000000">&clubs;</font>'},p:{name:"Pass",index:7,isStrain:!1,bid:!1,text:"P",html:'<font color="green">P</font>'},x:{name:"Double",index:6,isStrain:!1,bid:!1,text:"X",html:'<font color="red">X</font>'},r:{name:"Redouble",index:5,isStrain:!1,bid:!1,text:"XX",html:'<font color="blue">XX<font>'}},callOrder:[],ranks:{a:{name:"Ace",index:0,html:"A"},k:{name:"King",index:1,html:"K"},q:{name:"Queen",index:2,html:"Q"},j:{name:"Jack",index:3,html:"J"},
t:{name:"Ten",index:4,html:"T"},9:{name:"Nine",index:5,html:"9"},8:{name:"Eight",index:6,html:"8"},7:{name:"Seven",index:7,html:"7"},6:{name:"Six",index:8,html:"6"},5:{name:"Five",index:9,html:"5"},4:{name:"Four",index:10,html:"4"},3:{name:"Three",index:11,html:"3"},2:{name:"Two",index:12,html:"2"}},rankOrder:[],vulnerabilities:{"-":{name:"None",index:0,html:"None"},n:{name:"NS",index:0,html:"North-South"},e:{name:"EW",index:0,html:"East-West"},b:{name:"Both",index:0,html:"Both"}},_addKey:function(a){for(var b in a)a[b].key=
b},_createIndexArray:function(a){var b=[],c;for(c in a)b[a[c].index]=c;return b},_checkListMembership:function(a,b,c,d){_.has(b,a)||Bridge._reportError(a+" is not a valid "+c,d)},_belongsTo:function(a,b){return _.has(b,a)},_checkRequiredArgument:function(a,b,c){a||""===a||Bridge._reportError("Required argument "+b+" has not been specified",c)}};Bridge._addKey(Bridge.directions);Bridge._addKey(Bridge.suits);Bridge._addKey(Bridge.calls);Bridge._addKey(Bridge.ranks);Bridge._addKey(Bridge.vulnerabilities);
Bridge.directionOrder=Bridge._createIndexArray(Bridge.directions);Bridge.suitOrder=Bridge._createIndexArray(Bridge.suits);Bridge.callOrder=Bridge._createIndexArray(Bridge.calls);Bridge.rankOrder=Bridge._createIndexArray(Bridge.ranks);Bridge.options={useContextInErrorMessage:!1,enableDebug:!1};Bridge.getLHO=function(a){return Bridge.directions[a].lho};Bridge.getRHO=function(a){return Bridge.directions[a].rho};Bridge.getPartner=function(a){return Bridge.directions[a].cho};
Bridge.areOpponents=function(a,b){return Bridge.getLHO(a)===b||Bridge.getRHO(a)===b};Bridge.arePartners=function(a,b){return Bridge.getPartner(a)===b};Bridge.isStrain=function(a){return _.has(Bridge.calls,a)&&Bridge.calls[a].isStrain};Bridge.makeIdentifier=function(a){return a.trim().replace(/[^a-zA-Z0-9]+/g,"_")};Bridge.assignDefault=function(a,b){return"undefined"===typeof a?b:a};Bridge.getHash=function(a){return Bridge._getParameters(location.hash,"#",a)};
Bridge.getQuery=function(a){return Bridge._getQuery(document.URL,a)};Bridge._getQuery=function(a,b){return Bridge._getParameters(a,"?",b)};Bridge._getParameters=function(a,b,c){a=a.split(b);if(2>a.length)return{};a=a[1];c&&(a=a.split(c)[0]);return Bridge._parseParameterValues(a,"&","=")};
...
Bridge._reportError=function(a,b){if(!Bridge.options.useContextInErrorMessage)throw Error(a);throw Error((b?b+" - ":"")+a);};Bridge._checkDirection=function(a,b){Bridge._checkListMembership(a,Bridge.directions,"Direction",b)};Bridge.isDirection=function(a){return Bridge._belongsTo(a,Bridge.directions)};Bridge._checkSuit=function(a,b){Bridge._checkListMembership(a,Bridge.suits,"Suit",b)};Bridge.isSuit=function(a){return Bridge._belongsTo(a,Bridge.suits)};
Bridge._checkCall=function(a,b){Bridge._checkListMembership(a,Bridge.calls,"Call",b)};Bridge.isCall=function(a){return Bridge._belongsTo(a,Bridge.calls)};Bridge._checkLevel=function(a,b){var c=parseInt(a);(isNaN(c)||String(c)!==String(a)||1>c||7<c)&&Bridge._reportError(a+" is not a valid level",b)};Bridge.isLevel=function(a){var b=parseInt(a);return isNaN(b)||String(b)!==String(a)||1>b||7<b?!1:!0};
...
Bridge.isVulnerability=function(a){return Bridge._belongsTo(a,Bridge.vulnerabilities)};Bridge||(Bridge={});Bridge.Deal=function(){this._cardAssignedTo={};for(var a in Bridge.suits){this._cardAssignedTo[a]={};for(var b in Bridge.ranks)this._cardAssignedTo[a][b]=null}this.hands={};for(var c in Bridge.directions)this.hands[c]=new Bridge.Hand(c,this);this._activeHand="n";this.board=1;this.vulnerability="-";this.dealer="n";this.scoring="KO";this.notes="";this.auction=new Bridge.Auction(this);this.triggerEvents=!0};Bridge.Deal.prototype.enableEventTrigger=function(){this.triggerEvents=!0};
...
Bridge.Auction.prototype.setSelectedLevel=function(a){Bridge._checkLevel(a);this.selectedLevel=a;this.onChange("setSelectedLevel",a)};Bridge.Auction.prototype.unsetSelectedLevel=function(){this.selectedLevel=null;this.onChange("setSelectedLevel",this.selectedLevel)};Bridge.Auction.prototype.setAuction=function(a){Bridge._checkRequiredArgument(a);this.fromString(a)};Bridge.Auction.prototype.getAuction=function(){return this.toString()};
...
Bridge._generateHTMLModule=function(a,b,c,d){var e="",f=[a.prefix],m=Bridge._getTag(a,f),e=e+Bridge._openTag(m,a,f,[]);if(b)var f=[a.prefix+"-header"],l=Bridge._getTag(a,f),e=e+Bridge._openTag(l,a,f,[]),e=e+b+Bridge._closeTag(l);c&&(b=[a.prefix+"-content"],f=Bridge._getTag(a,b),e+=Bridge._openTag(f,a,b,[]),e+=c,e+=Bridge._closeTag(f));d&&(c=[a.prefix+"-footer"],b=Bridge._getTag(a,c),e+=Bridge._openTag(b,a,c,[]),e+=d,e+=Bridge._closeTag(b));return e+=Bridge._closeTag(m)};
...
Bridge.getSpanConfig=function(a){var b={};b[a]="div";b[a+"-header"]="span";b[a+"-content"]="span";b[a+"-footer"]="span";b[a+"-row"]="span";b[a+"-column"]="span";b[a+"-field"]="span";return b};
...
Bridge.Hand.prototype.toHTML=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{prefix:"hand-diagram",show:{},tags:{},data:{},classes:{},idPrefix:null,containerID:null,registerChangeHandler:!1});var c=a.prefix;_.defaults(a.show,{direction:!1,name:!1,countInHeader:!1,countInContent:!1,suit:!0,cards:!0,text:!0,emptySuit:!0});var d=Bridge.getSpanConfig(c);_.defaults(a.tags,d);a.registerChangeHandler&&!a.idPrefix&&Bridge._reportError("idPrefix is required if change handler has to registered");
var d="",e=Bridge._generateClasses(c,["row","info"]),f=Bridge._getTag(a,e);if(a.show.direction||a.show.name){var d=d+Bridge._openTag(f,a,e,[]),m=[],l="",g="direction";if(a.show[g])var m=Bridge._generateClasses(c,["column",g]),l=Bridge._getTag(a,m),d=d+Bridge._openTag(l,a,m,[]),k=Bridge._generateClasses(c,["field",g]),h=Bridge._getTag(a,k),q=["data-"+g+"='"+this.get(g)+"'"],d=d+Bridge._openTag(h,a,k,q),d=d+this.get(g).toUpperCase(),d=d+Bridge._closeTag(h),d=d+Bridge._closeTag(l);g="name";if(a.show[g]){m=
Bridge._generateClasses(c,["column",g]);l=Bridge._getTag(a,m);d+=Bridge._openTag(l,a,m,[]);k=Bridge._generateClasses(c,["field",g]);h=Bridge._getTag(a,k);q=["data-"+g+"='"+this.get(g)+"'"];d+=Bridge._openTag(h,a,k,q);d+=this.get(g);if(a.show.countInHeader)var p="count",k=Bridge._generateClasses(c,["field",p]),h=Bridge._getTag(a,k),q=["data-"+p+"='"+this.get(p)+"'"],d=d+Bridge._openTag(h,a,k,q),d=d+("("+this.get(p)+")"),d=d+Bridge._closeTag(h);d+=Bridge._closeTag(h);d+=Bridge._closeTag(l)}d+=Bridge._closeTag(f)}var n=
"",r=0;_.each(Bridge.suitOrder,function(b){e=Bridge._generateClasses(c,["row",b]);f=Bridge._getTag(a,e);n+=Bridge._openTag(f,a,e,[]);g="suit";if(a.show[g]){m=Bridge._generateClasses(c,["column",g,b]);l=Bridge._getTag(a,m);n+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",g,b]),h=Bridge._getTag(a,d),p=["data-"+g+"='"+b+"'"];n+=Bridge._openTag(h,a,d,p);n+=Bridge.suits[b].html;n+=Bridge._closeTag(h);n+=Bridge._closeTag(l)}g="cards";if(a.show[g]){m=Bridge._generateClasses(c,["column",
g,b]);l=Bridge._getTag(a,m);n+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",g,b]),h=Bridge._getTag(a,d),p=["data-suit='"+b+"'"],k="",q=0;_.each(Bridge.rankOrder,function(f){this.cards[b][f]&&(q++,d=Bridge._generateClasses(c,["field",g,b,f]),d.push(c+"-field-"+g+"-"+r),h=Bridge._getTag(a,d),k+=Bridge._openTag(h,a,d,["data-suit='"+b+"'","data-rank='"+f+"'","data-card='"+b+f+"'"]),a.show.text&&(k+=Bridge.ranks[f].html),k+=Bridge._closeTag(h),r++)},this);0===q&&a.show.emptySuit&&
a.show.text&&(k+="-");n+=k;n+=Bridge._closeTag(l)}n+=Bridge._closeTag(f)},this);a.show.countInContent&&(p="count",k=Bridge._generateClasses(c,["field",p]),h=Bridge._getTag(a,k),q=["data-"+p+"='"+this.get(p)+"'"],n+=Bridge._openTag(h,a,k,q),n+="("+this.get(p)+")",n+=Bridge._closeTag(h));d=Bridge._generateHTMLModule(a,d,n,"");a.containerID&&Bridge.embedHTML(a.containerID,d);!b&&a.registerChangeHandler&&(k=a.idPrefix+"-"+a.prefix,h="hand:changed."+k,$(document).off(h),$(document).on(h,{config:_.cloneDeep(a),
hand:this,id:k,event:h,direction:this.getDirection()},function(a,b){if(b===a.data.hand)if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toHTML(a.data.config,!0)}));return d};
...
["row","directions"]),d=Bridge._getTag(a,f),e=e+Bridge._openTag(d,a,f,[]),m=[],l="",g="direction",k=this.vulnerability;a.show[g]&&_.each(Bridge.directionOrder,function(b){m=Bridge._generateClasses(c,["column",g,b]);l=Bridge._getTag(a,m);e+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",g,b]);"b"!=k&&k!=b&&k!=Bridge.getPartner(b)||d.push("vulnerable");var h=Bridge._getTag(a,d);e+=Bridge._openTag(h,a,d,["data-"+g+"='"+b+"'"]);e+=b.toUpperCase();e+=Bridge._closeTag(h);e+=Bridge._closeTag(l)},
this);for(var e=e+Bridge._closeTag(d),h="",g="call",q=0,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),h=h+Bridge._openTag(d,a,f,[]),p="w",f=!0;this.dealer!==p;)var f=!1,p=Bridge.getLHO(p),m=Bridge._generateClasses(c,["column",g,p]),l=Bridge._getTag(a,m),h=h+Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",g,p]),r=Bridge._getTag(a,n),s=["data-"+g+"='' data-direction='"+p+"'"],h=h+Bridge._openTag(r,a,n,s),h=h+Bridge._closeTag(r),h=h+Bridge._closeTag(l);for(var u=
0;u<this.calls.length;++u){var t=this.calls[u],p=t.getDirection();"w"!==p||f||(h+=Bridge._closeTag(d),q++,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),h+=Bridge._openTag(d,a,f,[]));m=Bridge._generateClasses(c,["column",g,p]);l=Bridge._getTag(a,m);h+=Bridge._openTag(l,a,m,[]);n=Bridge._generateClasses(c,["field",g,p]);r=Bridge._getTag(a,n);s=["data-"+g+"='"+t.toString()+"' data-direction='"+p+"'"];h+=Bridge._openTag(r,a,n,s);h+=t.toHTML();h+=Bridge._closeTag(r);h+=Bridge._closeTag(l);
f=!1}0<this.calls.length&&(p=Bridge.getLHO(p));!this.getContract().isComplete&&a.addQuestionMark&&("w"===p&&(q++,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),h+=Bridge._closeTag(d),h+=Bridge._openTag(d,a,f,[])),m=Bridge._generateClasses(c,["column",g,p]),l=Bridge._getTag(a,m),h+=Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",g,p]),r=Bridge._getTag(a,n),s=["data-"+g+"='?' data-direction='"+p+"'"],h+=Bridge._openTag(r,a,n,s),h=h+"?"+Bridge._closeTag(r),h+=Bridge._closeTag(l),
p=Bridge.getLHO(p));for(;"w"!==p;)m=Bridge._generateClasses(c,["column",g,p]),l=Bridge._getTag(a,m),h+=Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",g,p]),r=Bridge._getTag(a,n),s=["data-"+g+"='' data-direction='"+p+"'"],h+=Bridge._openTag(r,a,n,s),h+=Bridge._closeTag(r),h+=Bridge._closeTag(l),p=Bridge.getLHO(p);h+=Bridge._closeTag(d);d=Bridge._generateHTMLModule(a,e,h,"");a.containerID&&Bridge.embedHTML(a.containerID,d);!b&&a.registerChangeHandler&&(h=a.idPrefix+"-"+a.prefix,q="auction:changed."+
h,$(document).on(q,{config:_.cloneDeep(a),auction:this,id:h,event:q},function(a,b){if(a.data.auction===b)if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toHTML(a.data.config,!0)}));return d};Bridge.Call.prototype.toHTML=function(a){a="";return a=1===this.call.length?a+Bridge.calls[this.call].html:a+(this.call[0]+Bridge.calls[this.call[1]].html)};
...
Bridge.Deal.prototype.toCardDeck=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{prefix:"card-deck",show:{},tags:{},data:{},classes:{},idPrefix:null,containerID:null,registerChangeHandler:!1});var c=a.prefix;_.defaults(a.show,{title:!0,activeHand:!0,text:!0,assignedTo:!0,reset:!1});var d=Bridge.getTableConfig(c);_.defaults(a.tags,d);var d="",e=Bridge._generateClasses(c,["row","title"]),f=Bridge._getTag(a,e),d=d+Bridge._openTag(f,a,e,[]),m=[],l="",g="title";if(a.show[g]){var m=
Bridge._generateClasses(c,["column",g]),l=Bridge._getTag(a,m),d=d+Bridge._openTag(l,a,m,["colspan=13"]),k=Bridge._generateClasses(c,["field",g]),h=Bridge._getTag(a,k),q=[],d=d+Bridge._openTag(h,a,k,q),q="Assign / Unassign cards";a.show.activeHand&&(q="Assign Cards to Active Hand : "+Bridge.directions[this.getActiveHand()].name+" / Unassign from any hand");d=d+q+Bridge._closeTag(h);d+=Bridge._closeTag(l)}var d=d+Bridge._closeTag(f),p="",g="cards";_.each(Bridge.suitOrder,function(b){e=Bridge._generateClasses(c,
["row",g,b]);f=Bridge._getTag(a,e);var d=["data-suit='"+b+"'"];p+=Bridge._openTag(f,a,e,d);_.each(Bridge.rankOrder,function(f){var e=this._cardAssignedTo[b][f];e||(e="");m=Bridge._generateClasses(c,["column",g,b,f]);e&&m.push("assigned");l=Bridge._getTag(a,m);d=["data-suit='"+b+"'","data-rank='"+f+"'","data-assignedto='"+e+"'"];p+=Bridge._openTag(l,a,m,d);k=Bridge._generateClasses(c,["field",g,b,f]);e?(k.push("assigned"),k.push("assigned-"+e)):k.push("unassigned");h=Bridge._getTag(a,k);p+=Bridge._openTag(h,
a,k,d);a.show.text&&(p+=Bridge.suits[b].html+Bridge.ranks[f].html);a.show.assignedTo&&e&&(p+="("+e.toUpperCase()+")");p+=Bridge._closeTag(h);p+=Bridge._closeTag(l)},this);p+=Bridge._closeTag(f)},this);var n="";a.show.reset&&(e=Bridge._generateClasses(c,["row","reset"]),f=Bridge._getTag(a,e),n+=Bridge._openTag(f,a,e,[]),m=[],l="",g="reset",m=Bridge._generateClasses(c,["column",g]),l=Bridge._getTag(a,m),n+=Bridge._openTag(l,a,m,["colspan=13"]),k=Bridge._generateClasses(c,["field",g]),h=Bridge._getTag(a,
k),q=[],n+=Bridge._openTag(h,a,k,q),n=n+"Reset/Clear Hand"+Bridge._closeTag(h),n+=Bridge._closeTag(l),n+=Bridge._closeTag(f));d=Bridge._generateHTMLModule(a,d,p,n);a.containerID&&(Bridge.embedHTML(a.containerID,d),$(document).trigger("card-deck:updated"));a.registerChangeHandler&&(q=a.idPrefix+"-"+a.prefix,$("#"+q).on("click",".card-deck-field-cards",{deal:this},function(a){try{var b=$(this).data("suit"),c=$(this).data("rank"),d=$(this).data("assignedto");d?a.data.deal.getHand(d).removeCard(b,c):
a.data.deal.getHand(a.data.deal.getActiveHand()).addCard(b,c)}catch(h){alert(h.message)}}),$("#"+q).on("click",".card-deck-field-reset",{deal:this},function(a){try{var b=a.data.deal;b.getHand(b.getActiveHand()).clearCards()}catch(c){alert(c.message)}}),b||(n="hand:changed."+q,$(document).off(n),$(document).on(n,{deal:this,config:_.cloneDeep(a),id:q,event:n},function(a,b){var c=a.data.id;console.log("card deck : "+a.data.event);0===$("#"+c).length?(c=a.data.event,$(document).off(c)):a.data.deal.toCardDeck(a.data.config,
!0)})));return d};
Bridge.Auction.prototype.toBiddingBox=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{layout:"full",prefix:"bidding-box",show:{},tags:{},data:{},classes:{},idPrefix:null,containerID:null,registerChangeHandler:!1});_.defaults(a.show,{allpass:!0,undo:!0,reset:!0});var c=Bridge.getTableConfig(a.prefix);_.defaults(a.tags,c);c="concise"===a.layout?this._createConciseBiddingBox(a):this._createFullBiddingBox(a);a.containerID&&Bridge.embedHTML(a.containerID,c);if(a.registerChangeHandler){var d=
a.idPrefix+"-"+a.prefix;$("#"+d).on("click",".bidding-box-field-level.enabled",{auction:this},function(a){var b=$(this).data("level");console.log("Level is "+b);a.data.auction.setSelectedLevel(b)});$("#"+d).on("click",".bidding-box-field-calls.enabled",{auction:this},function(a){try{var b=$(this).data("call"),c=a.data.auction;console.log("Call is "+b);"allpass"===b?c.addAllPass():"undo"===b?c.removeCall():"reset"===b?c.clearCalls():c.addCall(b)}catch(d){alert(d.message)}});if(!b){var e="bidding-box:changed."+
d;$(document).off(e);$(document).on(e,{config:_.cloneDeep(a),auction:this,id:d,event:e},function(a,b){if(b===a.data.auction){var c=a.data.id;console.log("bidding-box "+a.data.event);0===$("#"+c).length?(c=a.data.event,$(document).off(c)):b.toBiddingBox(a.data.config,!0)}})}}return c};
Bridge.Auction.prototype._createConciseBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),c=this.getSelectedLevel(),d=a.prefix,e=b.minimum_level,f="",m="level",l=Bridge._generateClasses(d,["row","level"]),g=Bridge._getTag(a,l),f=f+Bridge._openTag(g,a,l,[]);_.each(_.range(0,8),function(b){h=Bridge._generateClasses(d,["column",m,b]);var n=["data-level='"+b+"'"];q=Bridge._getTag(a,h);f+=Bridge._openTag(q,a,h,n);var g=Bridge._generateClasses(d,["field",m,b]),k=Bridge._getTag(a,
g);0!==b&&b===c&&g.push("selected");b>=e?g.push("enabled"):(g.push("disabled"),n.push("disabled"));f+=Bridge._openTag(k,a,g,n);0!==b&&(f+=b);f+=Bridge._closeTag(k);f+=Bridge._closeTag(q)},this);m="calls";l=Bridge._generateClasses(d,["row",m]);g=Bridge._getTag(a,l);f+=Bridge._openTag(g,a,l,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){var n=Bridge.isStrain(e)?Bridge.calls[e].html:Bridge.calls[e].text;h=Bridge._generateClasses(d,["column",m,e]);var g=Bridge.isStrain(e)?c+e:e,k=["data-suit='"+
e+"'","data-call='"+g+"'"];q=Bridge._getTag(a,h);f+=Bridge._openTag(q,a,h,k);var l=Bridge._generateClasses(d,["field",m,e]),t=Bridge._getTag(a,l);c&&Bridge.isStrain(e);b[g]?l.push("enabled"):(l.push("disabled"),k.push("disabled"));f+=Bridge._openTag(t,a,l,k);f+=n;f+=Bridge._closeTag(t);f+=Bridge._closeTag(q)},this);var f=f+Bridge._closeTag(g),k="",l=Bridge._generateClasses(d,["row","utilities"]),g=Bridge._getTag(a,l),k=k+Bridge._openTag(g,a,l,[]),h=[],q="",m="calls";_.each([{field:"allpass",text:"All Pass",
call:"allpass",bid:"p"},{field:"skip"},{field:"undo",text:"Undo",call:"undo",bid:"u"},{field:"skip"},{field:"reset",text:"Reset",call:"reset",bid:"u"}],function(c){h=Bridge._generateClasses(d,["column",m,c.field]);q=Bridge._getTag(a,h);var e=["data-bid='"+c.call+"'","data-call='"+c.call+"'"],f="skip"!==c.field?"colspan=2":"colspan=1";e.push(f);if(a.show[c.field]&&"skip"!==c.field){k+=Bridge._openTag(q,a,h,e);var f=Bridge._generateClasses(d,["field",m,c.field]),g=Bridge._getTag(a,f);b[c.bid]?f.push("enabled"):
(f.push("disabled"),e.push("disabled"));k+=Bridge._openTag(g,a,f,e);k+=c.text;k+=Bridge._closeTag(g)}else k+="<"+q+" "+f+">";k+=Bridge._closeTag(q)},this);k+=Bridge._closeTag(g);return Bridge._generateHTMLModule(a,"",f,k)};
Bridge.Auction.prototype._createFullBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),c=a.prefix,d="",e=Bridge._generateClasses(c,["row","special-bids"]),f=Bridge._getTag(a,e),d=d+Bridge._openTag(f,a,e,[]),m=[],l="",e=[{field:"pass",text:"Pass",call:"p",bid:"p"},{field:"skip"},{field:"double",text:"X",call:"x",bid:"x"},{field:"skip"},{field:"redouble",text:"XX",call:"r",bid:"r"}];_.each(e,function(e){m=Bridge._generateClasses(c,["column","calls",e.bid]);l=Bridge._getTag(a,
m);var f=["data-bid='"+e.call+"'","data-call='"+e.call+"'"];if("skip"!==e.field){d+=Bridge._openTag(l,a,m,f);var g=Bridge._generateClasses(c,["field","calls",e.bid]);b[e.bid]?g.push("enabled"):(g.push("disabled"),f.push("disabled"));var k=Bridge._getTag(a,g);d+=Bridge._openTag(k,a,g,f);d+=e.text;d+=Bridge._closeTag(k)}else d+="<"+l+"/>";d+=Bridge._closeTag(l)},this);var d=d+Bridge._closeTag(f),g="";_.each(_.range(1,8),function(d){var e=Bridge._generateClasses(c,["row","level",d]),f=Bridge._getTag(a,
e);g+=Bridge._openTag(f,a,e,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){if(Bridge.isStrain(e)){var f=d+e,k=d+Bridge.calls[e].html;m=Bridge._generateClasses(c,["column","calls",d,e]);var p=["data-level='"+d+"'","data-bid='"+e+"'","data-call='"+f+"'"];l=Bridge._getTag(a,m);g+=Bridge._openTag(l,a,m,p);e=Bridge._generateClasses(c,["field","calls",d,e]);var q=Bridge._getTag(a,e);b[f]?e.push("enabled"):(e.push("disabled"),p.push("disabled"));g+=Bridge._openTag(q,a,e,p);g+=k;g+=Bridge._closeTag(q);
g+=Bridge._closeTag(l)}},this);g+=Bridge._closeTag(f)},this);var k="",e=Bridge._generateClasses(c,["row","utilities"]),f=Bridge._getTag(a,e),k=k+Bridge._openTag(f,a,e,[]),m=[],l="",e=[{field:"allpass",text:"All Pass",call:"allpass",bid:"p"},{field:"skip"},{field:"undo",text:"Undo",call:"undo",bid:"u"},{field:"skip"},{field:"reset",text:"Reset",call:"reset",bid:"u"}];_.each(e,function(d){m=Bridge._generateClasses(c,["column","calls",d.field]);l=Bridge._getTag(a,m);var e=["data-bid='"+d.call+"'","data-call='"+
d.call+"'"];if(a.show[d.field]&&"skip"!==d.field){k+=Bridge._openTag(l,a,m,e);var f=Bridge._generateClasses(c,["field","calls",d.field]),g=Bridge._getTag(a,f);b[d.bid]?f.push("enabled"):(f.push("disabled"),e.push("disabled"));k+=Bridge._openTag(g,a,f,e);k+=d.text;k+=Bridge._closeTag(g)}else k+="<"+l+"/>";k+=Bridge._closeTag(l)},this);k+=Bridge._closeTag(f);return Bridge._generateHTMLModule(a,d,g,k)};
