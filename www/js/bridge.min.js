...
Bridge._addKey(Bridge.ranks);Bridge._addKey(Bridge.vulnerabilities);Bridge.directionOrder=Bridge._createIndexArray(Bridge.directions);Bridge.suitOrder=Bridge._createIndexArray(Bridge.suits);Bridge.callOrder=Bridge._createIndexArray(Bridge.calls);Bridge.rankOrder=Bridge._createIndexArray(Bridge.ranks);Bridge.options={useContextInErrorMessage:!1,enableDebug:!1};Bridge.getLHO=function(a){return Bridge.directions[a].lho};Bridge.getRHO=function(a){return Bridge.directions[a].rho};Bridge.getPartner=function(a){return Bridge.directions[a].cho};
...
var d="",e=Bridge._generateClasses(c,["row","info"]),f=Bridge._getTag(a,e);if(a.show.direction||a.show.name){var d=d+Bridge._openTag(f,a,e,[]),m=[],l="",h="direction";if(a.show[h])var m=Bridge._generateClasses(c,["column",h]),l=Bridge._getTag(a,m),d=d+Bridge._openTag(l,a,m,[]),k=Bridge._generateClasses(c,["field",h]),g=Bridge._getTag(a,k),q=["data-"+h+"='"+this.get(h)+"'"],d=d+Bridge._openTag(g,a,k,q),d=d+this.get(h).toUpperCase(),d=d+Bridge._closeTag(g),d=d+Bridge._closeTag(l);h="name";if(a.show[h]){m=
Bridge._generateClasses(c,["column",h]);l=Bridge._getTag(a,m);d+=Bridge._openTag(l,a,m,[]);k=Bridge._generateClasses(c,["field",h]);g=Bridge._getTag(a,k);q=["data-"+h+"='"+this.get(h)+"'"];d+=Bridge._openTag(g,a,k,q);d+=this.get(h);if(a.show.countInHeader)var p="count",k=Bridge._generateClasses(c,["field",p]),g=Bridge._getTag(a,k),q=["data-"+p+"='"+this.get(p)+"'"],d=d+Bridge._openTag(g,a,k,q),d=d+("("+this.get(p)+")"),d=d+Bridge._closeTag(g);d+=Bridge._closeTag(g);d+=Bridge._closeTag(l)}d+=Bridge._closeTag(f)}var n=
"",r=0,k=a.alternateSuitColor?this.getAlternatingSuitOrder():Bridge.suitOrder;_.each(k,function(b){e=Bridge._generateClasses(c,["row",b]);f=Bridge._getTag(a,e);n+=Bridge._openTag(f,a,e,[]);h="suit";if(a.show[h]){m=Bridge._generateClasses(c,["column",h,b]);l=Bridge._getTag(a,m);n+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",h,b]),g=Bridge._getTag(a,d),p=["data-"+h+"='"+b+"'"];n+=Bridge._openTag(g,a,d,p);n+=Bridge.suits[b].html;n+=Bridge._closeTag(g);n+=Bridge._closeTag(l)}h=
"cards";if(a.show[h]){m=Bridge._generateClasses(c,["column",h,b]);l=Bridge._getTag(a,m);n+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",h,b]),g=Bridge._getTag(a,d),p=["data-suit='"+b+"'"],k="",q=0;_.each(Bridge.rankOrder,function(f){this.cards[b][f]&&(q++,d=Bridge._generateClasses(c,["field",h,b,f]),d.push(c+"-field-"+h+"-"+r),g=Bridge._getTag(a,d),k+=Bridge._openTag(g,a,d,["data-suit='"+b+"'","data-rank='"+f+"'","data-card='"+b+f+"'"]),a.show.text&&(k+=Bridge.ranks[f].html),
k+=Bridge._closeTag(g),r++)},this);0===q&&a.show.emptySuit&&a.show.text&&(k+="-");n+=k;n+=Bridge._closeTag(l)}n+=Bridge._closeTag(f)},this);a.show.countInContent&&(p="count",k=Bridge._generateClasses(c,["field",p]),g=Bridge._getTag(a,k),q=["data-"+p+"='"+this.get(p)+"'"],n+=Bridge._openTag(g,a,k,q),n+="("+this.get(p)+")",n+=Bridge._closeTag(g));d=Bridge._generateHTMLModule(a,d,n,"");a.containerID&&Bridge.embedHTML(a.containerID,d);!b&&a.registerChangeHandler&&(k=a.idPrefix+"-"+a.prefix,g="hand:changed."+
k,$(document).off(g),$(document).on(g,{config:_.cloneDeep(a),hand:this,id:k,event:g,direction:this.getDirection()},function(a,b){if(b===a.data.hand)if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toHTML(a.data.config,!0)}));return d};
...
["row","directions"]),d=Bridge._getTag(a,f),e=e+Bridge._openTag(d,a,f,[]),m=[],l="",h="direction",k=this.vulnerability;a.show[h]&&_.each(Bridge.directionOrder,function(b){m=Bridge._generateClasses(c,["column",h,b]);l=Bridge._getTag(a,m);e+=Bridge._openTag(l,a,m,[]);var d=Bridge._generateClasses(c,["field",h,b]);"b"!=k&&k!=b&&k!=Bridge.getPartner(b)||d.push("vulnerable");var g=Bridge._getTag(a,d);e+=Bridge._openTag(g,a,d,["data-"+h+"='"+b+"'"]);e+=b.toUpperCase();e+=Bridge._closeTag(g);e+=Bridge._closeTag(l)},
this);for(var e=e+Bridge._closeTag(d),g="",h="call",q=0,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),g=g+Bridge._openTag(d,a,f,[]),p="w",f=!0;this.dealer!==p;)var f=!1,p=Bridge.getLHO(p),m=Bridge._generateClasses(c,["column",h,p]),l=Bridge._getTag(a,m),g=g+Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",h,p]),r=Bridge._getTag(a,n),s=["data-"+h+"='' data-direction='"+p+"'"],g=g+Bridge._openTag(r,a,n,s),g=g+Bridge._closeTag(r),g=g+Bridge._closeTag(l);for(var u=
0;u<this.calls.length;++u){var t=this.calls[u],p=t.getDirection();"w"!==p||f||(g+=Bridge._closeTag(d),q++,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),g+=Bridge._openTag(d,a,f,[]));m=Bridge._generateClasses(c,["column",h,p]);l=Bridge._getTag(a,m);g+=Bridge._openTag(l,a,m,[]);n=Bridge._generateClasses(c,["field",h,p]);r=Bridge._getTag(a,n);s=["data-"+h+"='"+t.toString()+"' data-direction='"+p+"'"];g+=Bridge._openTag(r,a,n,s);g+=t.toHTML();g+=Bridge._closeTag(r);g+=Bridge._closeTag(l);
f=!1}0<this.calls.length&&(p=Bridge.getLHO(p));!this.getContract().isComplete&&a.addQuestionMark&&("w"===p&&(q++,f=Bridge._generateClasses(c,["row","calls",q]),d=Bridge._getTag(a,f),g+=Bridge._closeTag(d),g+=Bridge._openTag(d,a,f,[])),m=Bridge._generateClasses(c,["column",h,p]),l=Bridge._getTag(a,m),g+=Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",h,p]),r=Bridge._getTag(a,n),s=["data-"+h+"='?' data-direction='"+p+"'"],g+=Bridge._openTag(r,a,n,s),g=g+"?"+Bridge._closeTag(r),g+=Bridge._closeTag(l),
p=Bridge.getLHO(p));for(;"w"!==p;)m=Bridge._generateClasses(c,["column",h,p]),l=Bridge._getTag(a,m),g+=Bridge._openTag(l,a,m,[]),n=Bridge._generateClasses(c,["field",h,p]),r=Bridge._getTag(a,n),s=["data-"+h+"='' data-direction='"+p+"'"],g+=Bridge._openTag(r,a,n,s),g+=Bridge._closeTag(r),g+=Bridge._closeTag(l),p=Bridge.getLHO(p);g+=Bridge._closeTag(d);d=Bridge._generateHTMLModule(a,e,g,"");a.containerID&&Bridge.embedHTML(a.containerID,d);!b&&a.registerChangeHandler&&(g=a.idPrefix+"-"+a.prefix,q="auction:changed."+
g,$(document).on(q,{config:_.cloneDeep(a),auction:this,id:g,event:q},function(a,b){if(a.data.auction===b)if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toHTML(a.data.config,!0)}));return d};Bridge.getCallHTML=function(a){var b=a.length;if(1>b||2<b)return a;Bridge._checkBid(a);if(1===b)return Bridge.calls[a].html;if(2===b)return a[0]+Bridge.calls[a[1]].html};
Bridge.getCardHTML=function(a){if(2!==a.length)return a;Bridge._checkSuit(a[0]);Bridge._checkRank(a[1]);return Bridge.suits[a[0]].html+Bridge.ranks[a[1]].html};Bridge.Call.prototype.toHTML=function(a){a="";return a=1===this.call.length?a+Bridge.calls[this.call].html:a+(this.call[0]+Bridge.calls[this.call[1]].html)};
...
Bridge.Deal.prototype.toCardDeck=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{prefix:"card-deck",show:{},tags:{},data:{},classes:{},idPrefix:null,containerID:null,registerChangeHandler:!1});var c=a.prefix;_.defaults(a.show,{title:!0,activeHand:!0,text:!0,assignedTo:!0,reset:!1});var d=Bridge.getTableConfig(c);_.defaults(a.tags,d);var d="",e=Bridge._generateClasses(c,["row","title"]),f=Bridge._getTag(a,e),d=d+Bridge._openTag(f,a,e,[]),m=[],l="",h="title";if(a.show[h]){var m=
Bridge._generateClasses(c,["column",h]),l=Bridge._getTag(a,m),d=d+Bridge._openTag(l,a,m,["colspan=13"]),k=Bridge._generateClasses(c,["field",h]),g=Bridge._getTag(a,k),q=[],d=d+Bridge._openTag(g,a,k,q),q="Assign / Unassign cards";a.show.activeHand&&(q="Assign Cards to Active Hand : "+Bridge.directions[this.getActiveHand()].name+" / Unassign from any hand");d=d+q+Bridge._closeTag(g);d+=Bridge._closeTag(l)}var d=d+Bridge._closeTag(f),p="",h="cards";_.each(Bridge.suitOrder,function(b){e=Bridge._generateClasses(c,
["row",h,b]);f=Bridge._getTag(a,e);var d=["data-suit='"+b+"'"];p+=Bridge._openTag(f,a,e,d);_.each(Bridge.rankOrder,function(f){var e=this._cardAssignedTo[b][f];e||(e="");m=Bridge._generateClasses(c,["column",h,b,f]);e&&m.push("assigned");l=Bridge._getTag(a,m);d=["data-suit='"+b+"'","data-rank='"+f+"'","data-assignedto='"+e+"'"];p+=Bridge._openTag(l,a,m,d);k=Bridge._generateClasses(c,["field",h,b,f]);e?(k.push("assigned"),k.push("assigned-"+e)):k.push("unassigned");g=Bridge._getTag(a,k);p+=Bridge._openTag(g,
a,k,d);a.show.text&&(p+=Bridge.suits[b].html+Bridge.ranks[f].html);a.show.assignedTo&&e&&(p+="("+e.toUpperCase()+")");p+=Bridge._closeTag(g);p+=Bridge._closeTag(l)},this);p+=Bridge._closeTag(f)},this);var n="";a.show.reset&&(e=Bridge._generateClasses(c,["row","reset"]),f=Bridge._getTag(a,e),n+=Bridge._openTag(f,a,e,[]),m=[],l="",h="reset",m=Bridge._generateClasses(c,["column",h]),l=Bridge._getTag(a,m),n+=Bridge._openTag(l,a,m,["colspan=13"]),k=Bridge._generateClasses(c,["field",h]),g=Bridge._getTag(a,
k),q=[],n+=Bridge._openTag(g,a,k,q),n=n+"Reset/Clear Hand"+Bridge._closeTag(g),n+=Bridge._closeTag(l),n+=Bridge._closeTag(f));d=Bridge._generateHTMLModule(a,d,p,n);a.containerID&&(Bridge.embedHTML(a.containerID,d),$(document).trigger("card-deck:updated"));a.registerChangeHandler&&(q=a.idPrefix+"-"+a.prefix,$("#"+q).on("click","."+a.prefix+"-field-cards",{deal:this},function(a){try{var b=$(this).data("suit"),c=$(this).data("rank"),d=$(this).data("assignedto");d?a.data.deal.getHand(d).removeCard(b,
c):a.data.deal.getHand(a.data.deal.getActiveHand()).addCard(b,c)}catch(g){alert(g.message)}}),$("#"+q).on("click","."+a.prefix+"-field-reset",{deal:this},function(a){try{var b=a.data.deal;b.getHand(b.getActiveHand()).clearCards()}catch(c){alert(c.message)}}),b||(n="hand:changed."+q,$(document).off(n),$(document).on(n,{deal:this,config:_.cloneDeep(a),id:q,event:n},function(a,b){if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else a.data.deal.toCardDeck(a.data.config,!0)})));return d};
...
a.idPrefix+"-"+a.prefix;$("#"+d).on("click","."+a.prefix+"-field-level.enabled",{auction:this},function(a){var b=$(this).data("level");a.data.auction.setSelectedLevel(b)});$("#"+d).on("click","."+a.prefix+"-field-calls.enabled",{auction:this},function(a){try{var b=$(this).data("call"),c=a.data.auction;"allpass"===b?c.addAllPass():"undo"===b?c.removeCall():"reset"===b?c.clearCalls():c.addCall(b)}catch(d){alert(d.message)}});if(!b){var e="bidding-box:changed."+d;$(document).off(e);$(document).on(e,
{config:_.cloneDeep(a),auction:this,id:d,event:e},function(a,b){if(b===a.data.auction)if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toBiddingBox(a.data.config,!0)})}}return c};
Bridge.Auction.prototype._createConciseBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),c=this.getSelectedLevel(),d=a.prefix,e=b.minimum_level,f="",m="level",l=Bridge._generateClasses(d,["row","level"]),h=Bridge._getTag(a,l),f=f+Bridge._openTag(h,a,l,[]);_.each(_.range(0,8),function(b){g=Bridge._generateClasses(d,["column",m,b]);var n=["data-level='"+b+"'"];q=Bridge._getTag(a,g);f+=Bridge._openTag(q,a,g,n);var k=Bridge._generateClasses(d,["field",m,b]),h=Bridge._getTag(a,
k);0!==b&&b===c&&k.push("selected");b>=e?k.push("enabled"):(k.push("disabled"),n.push("disabled"));f+=Bridge._openTag(h,a,k,n);0!==b&&(f+=b);f+=Bridge._closeTag(h);f+=Bridge._closeTag(q)},this);m="calls";l=Bridge._generateClasses(d,["row",m]);h=Bridge._getTag(a,l);f+=Bridge._openTag(h,a,l,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){var n=Bridge.isStrain(e)?Bridge.calls[e].html:Bridge.calls[e].text;g=Bridge._generateClasses(d,["column",m,e]);var k=Bridge.isStrain(e)?c+e:e,h=["data-suit='"+
e+"'","data-call='"+k+"'"];q=Bridge._getTag(a,g);f+=Bridge._openTag(q,a,g,h);var l=Bridge._generateClasses(d,["field",m,e]),t=Bridge._getTag(a,l);c&&Bridge.isStrain(e);b[k]?l.push("enabled"):(l.push("disabled"),h.push("disabled"));f+=Bridge._openTag(t,a,l,h);f+=n;f+=Bridge._closeTag(t);f+=Bridge._closeTag(q)},this);var f=f+Bridge._closeTag(h),k="",l=Bridge._generateClasses(d,["row","utilities"]),h=Bridge._getTag(a,l),k=k+Bridge._openTag(h,a,l,[]),g=[],q="",m="calls";_.each([{field:"allpass",text:"All Pass",
call:"allpass",bid:"p"},{field:"skip"},{field:"undo",text:"Undo",call:"undo",bid:"u"},{field:"skip"},{field:"reset",text:"Reset",call:"reset",bid:"u"}],function(c){g=Bridge._generateClasses(d,["column",m,c.field]);q=Bridge._getTag(a,g);var e=["data-bid='"+c.call+"'","data-call='"+c.call+"'"],f="skip"!==c.field?"colspan=2":"colspan=1";e.push(f);if(a.show[c.field]&&"skip"!==c.field){k+=Bridge._openTag(q,a,g,e);var f=Bridge._generateClasses(d,["field",m,c.field]),h=Bridge._getTag(a,f);b[c.bid]?f.push("enabled"):
(f.push("disabled"),e.push("disabled"));k+=Bridge._openTag(h,a,f,e);k+=c.text;k+=Bridge._closeTag(h)}else k+="<"+q+" "+f+">";k+=Bridge._closeTag(q)},this);k+=Bridge._closeTag(h);return Bridge._generateHTMLModule(a,"",f,k)};
...
m);var f=["data-bid='"+e.call+"'","data-call='"+e.call+"'"];if("skip"!==e.field){d+=Bridge._openTag(l,a,m,f);var h=Bridge._generateClasses(c,["field","calls",e.bid]);b[e.bid]?h.push("enabled"):(h.push("disabled"),f.push("disabled"));var k=Bridge._getTag(a,h);d+=Bridge._openTag(k,a,h,f);d+=e.text;d+=Bridge._closeTag(k)}else d+="<"+l+"/>";d+=Bridge._closeTag(l)},this);var d=d+Bridge._closeTag(f),h="";_.each(_.range(1,8),function(d){var e=Bridge._generateClasses(c,["row","level",d]),f=Bridge._getTag(a,
e);h+=Bridge._openTag(f,a,e,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){if(Bridge.isStrain(e)){var f=d+e,k=d+Bridge.calls[e].html;m=Bridge._generateClasses(c,["column","calls",d,e]);var p=["data-level='"+d+"'","data-bid='"+e+"'","data-call='"+f+"'"];l=Bridge._getTag(a,m);h+=Bridge._openTag(l,a,m,p);e=Bridge._generateClasses(c,["field","calls",d,e]);var q=Bridge._getTag(a,e);b[f]?e.push("enabled"):(e.push("disabled"),p.push("disabled"));h+=Bridge._openTag(q,a,e,p);h+=k;h+=Bridge._closeTag(q);
h+=Bridge._closeTag(l)}},this);h+=Bridge._closeTag(f)},this);var k="",e=Bridge._generateClasses(c,["row","utilities"]),f=Bridge._getTag(a,e),k=k+Bridge._openTag(f,a,e,[]),m=[],l="",e=[{field:"allpass",text:"All Pass",call:"allpass",bid:"p"},{field:"skip"},{field:"undo",text:"Undo",call:"undo",bid:"u"},{field:"skip"},{field:"reset",text:"Reset",call:"reset",bid:"u"}];_.each(e,function(d){m=Bridge._generateClasses(c,["column","calls",d.field]);l=Bridge._getTag(a,m);var e=["data-bid='"+d.call+"'","data-call='"+
d.call+"'"];if(a.show[d.field]&&"skip"!==d.field){k+=Bridge._openTag(l,a,m,e);var f=Bridge._generateClasses(c,["field","calls",d.field]),h=Bridge._getTag(a,f);b[d.bid]?f.push("enabled"):(f.push("disabled"),e.push("disabled"));k+=Bridge._openTag(h,a,f,e);k+=d.text;k+=Bridge._closeTag(h)}else k+="<"+l+"/>";k+=Bridge._closeTag(l)},this);k+=Bridge._closeTag(f);return Bridge._generateHTMLModule(a,d,h,k)};
