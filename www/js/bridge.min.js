...
Bridge.Auction.prototype.toString=function(){for(var a="",b=0;b<this.calls.length;++b)a+=this.calls[b].toString();return a};Bridge.Auction.prototype.toJSON=function(){return this.toString()};Bridge.Auction.prototype.onChange=function(a,b){$(document).trigger("auction:changed",[this,a,b]);$(document).trigger("bidding-box:changed",[this,a,b]);this.deal&&$(document).trigger("deal:changed",[this.deal,a,b])};Bridge||(Bridge={});Bridge.Contract=function(){this.suit=this.level=null;this.redoubled=this.doubled=!1;this.declarer=null;this.firstToBid={};for(var a in Bridge.calls)if(Bridge.isBid(a)){this.firstToBid[a]={};for(var b in Bridge.directions)this.firstToBid[a][b]=null}this.numPasses=0;this.isComplete=!1};
...
c);a.registerChangeHandler&&!a.idPrefix&&Bridge._reportError("idPrefix is required if change handler has to registered");var c="",e=Bridge._generateClasses(d,["row","info"]),f=Bridge._getTag(a,e),c=c+Bridge._openTag(f,a,e,[]),n=[],l="",h="direction";if(a.show[h])var n=Bridge._generateClasses(d,["column",h]),l=Bridge._getTag(a,n),c=c+Bridge._openTag(l,a,n,[]),k=Bridge._generateClasses(d,["field",h]),g=Bridge._getTag(a,k),q=["data-"+h+"='"+this.get(h)+"'"],c=c+Bridge._openTag(g,a,k,q),c=c+this.get(h).toUpperCase(),
c=c+Bridge._closeTag(g),c=c+Bridge._closeTag(l);h="name";if(a.show[h]){n=Bridge._generateClasses(d,["column",h]);l=Bridge._getTag(a,n);c+=Bridge._openTag(l,a,n,[]);k=Bridge._generateClasses(d,["field",h]);g=Bridge._getTag(a,k);q=["data-"+h+"='"+this.get(h)+"'"];c+=Bridge._openTag(g,a,k,q);c+=this.get(h);if(a.show.countInHeader)var m="count",k=Bridge._generateClasses(d,["field",m]),g=Bridge._getTag(a,k),q=["data-"+m+"='"+this.get(m)+"'"],c=c+Bridge._openTag(g,a,k,q),c=c+("("+this.get(m)+")"),c=c+Bridge._closeTag(g);
c+=Bridge._closeTag(g);c+=Bridge._closeTag(l)}var c=c+Bridge._closeTag(f),p="";_.each(Bridge.suitOrder,function(b){e=Bridge._generateClasses(d,["row",b]);f=Bridge._getTag(a,e);p+=Bridge._openTag(f,a,e,[]);h="suit";if(a.show[h]){n=Bridge._generateClasses(d,["column",h,b]);l=Bridge._getTag(a,n);p+=Bridge._openTag(l,a,n,[]);var c=Bridge._generateClasses(d,["field",h,b]),g=Bridge._getTag(a,c),m=["data-"+h+"='"+b+"'"];p+=Bridge._openTag(g,a,c,m);p+=Bridge.suits[b].html;p+=Bridge._closeTag(g);p+=Bridge._closeTag(l)}h=
"cards";if(a.show[h]){n=Bridge._generateClasses(d,["column",h,b]);l=Bridge._getTag(a,n);p+=Bridge._openTag(l,a,n,[]);var c=Bridge._generateClasses(d,["field",h,b]),g=Bridge._getTag(a,c),m=["data-"+h+"='"+b+"'"],k="",q=0;_.each(Bridge.rankOrder,function(f){this.cards[b][f]&&(q++,c=Bridge._generateClasses(d,["field",h,b,f]),g=Bridge._getTag(a,c),k+=Bridge._openTag(g,a,c,m),k+=Bridge.ranks[f].html,k+=Bridge._closeTag(g))},this);0===q&&(k+="-");p+=k;p+=Bridge._closeTag(l)}p+=Bridge._closeTag(f)},this);
a.show.countInContent&&(m="count",k=Bridge._generateClasses(d,["field",m]),g=Bridge._getTag(a,k),q=["data-"+m+"='"+this.get(m)+"'"],p+=Bridge._openTag(g,a,k,q),p+="("+this.get(m)+")",p+=Bridge._closeTag(g));c=Bridge._generateHTMLModule(a,c,p,"");a.containerID&&Bridge.embedHTML(a.containerID,c);!b&&a.registerChangeHandler&&(k=a.idPrefix+"-"+a.prefix,g="hand:changed."+k,$(document).on(g,{config:_.cloneDeep(a),id:k,event:g,direction:this.getDirection()},function(a,b){if(0===$("#"+a.data.id).length){var c=
a.data.event;$(document).off(c)}else b.getDirection()===a.data.direction&&b.toHTML(a.data.config,!0)}));return c};
...
Bridge._reportError("idPrefix is required if change handler has to registered");var e="",f=Bridge._generateClasses(d,["row","directions"]),c=Bridge._getTag(a,f),e=e+Bridge._openTag(c,a,f,[]),n=[],l="",h="direction",k=this.vulnerability;a.show[h]&&_.each(Bridge.directionOrder,function(b){n=Bridge._generateClasses(d,["column",h,b]);l=Bridge._getTag(a,n);e+=Bridge._openTag(l,a,n,[]);var c=Bridge._generateClasses(d,["field",h,b]);"b"!=k&&k!=b&&k!=Bridge.getPartner(b)||c.push("vulnerable");var g=Bridge._getTag(a,
c);e+=Bridge._openTag(g,a,c,["data-"+h+"='"+b+"'"]);e+=b.toUpperCase();e+=Bridge._closeTag(g);e+=Bridge._closeTag(l)},this);for(var e=e+Bridge._closeTag(c),g="",h="call",q=0,f=Bridge._generateClasses(d,["row","calls",q]),c=Bridge._getTag(a,f),g=g+Bridge._openTag(c,a,f,[]),m="w",f=!0;this.dealer!==m;)var f=!1,m=Bridge.getLHO(m),n=Bridge._generateClasses(d,["column",h,m]),l=Bridge._getTag(a,n),g=g+Bridge._openTag(l,a,n,[]),p=Bridge._generateClasses(d,["field",h,m]),r=Bridge._getTag(a,p),s=["data-"+
h+"='' data-direction='"+m+"'"],g=g+Bridge._openTag(r,a,p,s),g=g+Bridge._closeTag(r),g=g+Bridge._closeTag(l);for(var t=0;t<this.calls.length;++t){var u=this.calls[t],m=u.getDirection();"w"!==m||f||(g+=Bridge._closeTag(c),q++,f=Bridge._generateClasses(d,["row","calls",q]),c=Bridge._getTag(a,f),g+=Bridge._openTag(c,a,f,[]));n=Bridge._generateClasses(d,["column",h,m]);l=Bridge._getTag(a,n);g+=Bridge._openTag(l,a,n,[]);p=Bridge._generateClasses(d,["field",h,m]);r=Bridge._getTag(a,p);s=["data-"+h+"='"+
u.toString()+"' data-direction='"+m+"'"];g+=Bridge._openTag(r,a,p,s);g+=u.toHTML();g+=Bridge._closeTag(r);g+=Bridge._closeTag(l);f=!1}0<this.calls.length&&(m=Bridge.getLHO(m));!this.getContract().isComplete&&a.addQuestionMark&&("w"===m&&(q++,f=Bridge._generateClasses(d,["row","calls",q]),c=Bridge._getTag(a,f),g+=Bridge._closeTag(c),g+=Bridge._openTag(c,a,f,[])),n=Bridge._generateClasses(d,["column",h,m]),l=Bridge._getTag(a,n),g+=Bridge._openTag(l,a,n,[]),p=Bridge._generateClasses(d,["field",h,m]),
r=Bridge._getTag(a,p),s=["data-"+h+"='?' data-direction='"+m+"'"],g+=Bridge._openTag(r,a,p,s),g=g+"?"+Bridge._closeTag(r),g+=Bridge._closeTag(l),m=Bridge.getLHO(m));for(;"w"!==m;)n=Bridge._generateClasses(d,["column",h,m]),l=Bridge._getTag(a,n),g+=Bridge._openTag(l,a,n,[]),p=Bridge._generateClasses(d,["field",h,m]),r=Bridge._getTag(a,p),s=["data-"+h+"='' data-direction='"+m+"'"],g+=Bridge._openTag(r,a,p,s),g+=Bridge._closeTag(r),g+=Bridge._closeTag(l),m=Bridge.getLHO(m);g+=Bridge._closeTag(c);c=Bridge._generateHTMLModule(a,
...
Bridge.Deal.prototype.toCardDeck=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{prefix:"card-deck",show:{},tags:{},data:{},classes:{},idPrefix:null,containerID:null,registerChangeHandler:!0});var d=a.prefix;_.defaults(a.show,{title:!0,activeHand:!0,text:!0,assignedTo:!0});var c={};c[d]="table";c[d+"-header"]="thead";c[d+"-content"]="tbody";c[d+"-footer"]="tfoot";c[d+"-row"]="tr";c[d+"-column"]="td";c[d+"-field"]="span";_.defaults(a.tags,c);var c="",e=Bridge._generateClasses(d,
["row","title"]),f=Bridge._getTag(a,e),c=c+Bridge._openTag(f,a,e,[]),n=[],l="",h="title";if(a.show[h]){var n=Bridge._generateClasses(d,["column",h]),l=Bridge._getTag(a,n),c=c+Bridge._openTag(l,a,n,["colspan=13"]),k=Bridge._generateClasses(d,["field",h]),g=Bridge._getTag(a,k),c=c+Bridge._openTag(g,a,k,[]),q="Assign / Unassign cards";a.show.activeHand&&(q="Assign Cards to Active Hand : "+Bridge.directions[this.getActiveHand()].name+" / Unassign from any hand");c=c+q+Bridge._closeTag(g);c+=Bridge._closeTag(l)}var c=
c+Bridge._closeTag(f),m="",h="cards";_.each(Bridge.suitOrder,function(b){e=Bridge._generateClasses(d,["row",h,b]);f=Bridge._getTag(a,e);var c=["data-suit='"+b+"'"];m+=Bridge._openTag(f,a,e,c);_.each(Bridge.rankOrder,function(f){var e=this._cardAssignedTo[b][f];e||(e="");n=Bridge._generateClasses(d,["column",h,b,f]);e&&n.push("assigned");l=Bridge._getTag(a,n);c=["data-suit='"+b+"'","data-rank='"+f+"'","data-assignedto='"+e+"'"];m+=Bridge._openTag(l,a,n,c);k=Bridge._generateClasses(d,["field",h,b,f]);
e?(k.push("assigned"),k.push("assigned-"+e)):k.push("unassigned");g=Bridge._getTag(a,k);m+=Bridge._openTag(g,a,k,c);a.show.text&&(m+=Bridge.suits[b].html+Bridge.ranks[f].html);a.show.assignedTo&&e&&(m+="("+e.toUpperCase()+")");m+=Bridge._closeTag(g);m+=Bridge._closeTag(l)},this);m+=Bridge._closeTag(f)},this);c=Bridge._generateHTMLModule(a,c,m,"");a.containerID&&Bridge.embedHTML(a.containerID,c);if(a.registerChangeHandler&&(q=a.idPrefix+"-"+a.prefix,$("#"+q).on("click",".card-deck-field-cards",{deal:this},
function(a){try{var b=$(this).data("suit"),c=$(this).data("rank"),d=$(this).data("assignedto");d?a.data.deal.getHand(d).removeCard(b,c):a.data.deal.getHand(a.data.deal.getActiveHand()).addCard(b,c)}catch(g){alert(g.message)}}),!b)){var p="hand:changed."+q;$(document).on(p,{deal:this,config:_.cloneDeep(a),id:q,event:p},function(a,b){var c=a.data.id;console.log("Event id = "+c);0===$("#"+c).length?(c=a.data.event,$(document).off(c)):a.data.deal.toCardDeck(a.data.config,!0)})}return c};
...
b?c.addAllPass():"undo"===b?c.removeCall():"reset"===b?c.clearCalls():c.addCall(b)}catch(d){alert(d.message)}}),!b)){var e="bidding-box:changed."+c;$(document).on(e,{config:_.cloneDeep(a),id:c,event:e},function(a,b){if(0===$("#"+a.data.id).length){var c=a.data.event;$(document).off(c)}else b.toBiddingBox(a.data.config,!0)})}return d};
Bridge.Auction.prototype._createConciseBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),d=this.getSelectedLevel(),c=a.prefix,e=b.minimum_level,f="",n="level",l=Bridge._generateClasses(c,["row","level"]),h=Bridge._getTag(a,l),f=f+Bridge._openTag(h,a,l,[]);_.each(_.range(0,8),function(b){g=Bridge._generateClasses(c,["column",n,b]);data=["data-level='"+b+"'"];q=Bridge._getTag(a,g);if(0===b)f+="<"+q+"/>";else{f+=Bridge._openTag(q,a,g,data);var h=Bridge._generateClasses(c,
["field",n,b]),k=Bridge._getTag(a,h);b===d&&h.push("selected");b>=e?h.push("enabled"):(h.push("disabled"),data.push("disabled"));f+=Bridge._openTag(k,a,h,data);f+=b;f+=Bridge._closeTag(k)}f+=Bridge._closeTag(q)},this);n="calls";l=Bridge._generateClasses(c,["row",n]);h=Bridge._getTag(a,l);f+=Bridge._openTag(h,a,l,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){var h=Bridge.isBid(e)?Bridge.calls[e].html:Bridge.calls[e].text;g=Bridge._generateClasses(c,["column",n,e]);var k=Bridge.isBid(e)?
d+e:e;data=["data-suit='"+e+"'","data-call='"+k+"'"];q=Bridge._getTag(a,g);f+=Bridge._openTag(q,a,g,data);var l=Bridge._generateClasses(c,["field",n,e]),t=Bridge._getTag(a,l);d&&Bridge.isBid(e);b[k]?l.push("enabled"):(l.push("disabled"),data.push("disabled"));f+=Bridge._openTag(t,a,l,data);f+=h;f+=Bridge._closeTag(t);f+=Bridge._closeTag(q)},this);var f=f+Bridge._closeTag(h),k="",l=Bridge._generateClasses(c,["row","utilities"]),h=Bridge._getTag(a,l),k=k+Bridge._openTag(h,a,l,[]),g=[],q="",n="calls";
...
Bridge.Auction.prototype._createFullBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),d=a.prefix,c="",e=Bridge._generateClasses(d,["row","special-bids"]),f=Bridge._getTag(a,e),c=c+Bridge._openTag(f,a,e,[]),n=[],l="",e=[{field:"pass",text:"Pass",call:"p",bid:"p"},{field:"skip"},{field:"double",text:"X",call:"x",bid:"x"},{field:"skip"},{field:"redouble",text:"XX",call:"r",bid:"r"}];_.each(e,function(e){n=Bridge._generateClasses(d,["column","calls",e.bid]);l=Bridge._getTag(a,
n);var f=["data-bid='"+e.call+"'","data-call='"+e.call+"'"];if("skip"!==e.field){c+=Bridge._openTag(l,a,n,f);var h=Bridge._generateClasses(d,["field","calls",e.bid]);b[e.bid]?h.push("enabled"):(h.push("disabled"),f.push("disabled"));var k=Bridge._getTag(a,h);c+=Bridge._openTag(k,a,h,f);c+=e.text;c+=Bridge._closeTag(k)}else c+="<"+l+"/>";c+=Bridge._closeTag(l)},this);var c=c+Bridge._closeTag(f),h="";_.each(_.range(1,8),function(c){var e=Bridge._generateClasses(d,["row","level",c]),f=Bridge._getTag(a,
e);h+=Bridge._openTag(f,a,e,[]);_.each(Bridge.callOrder.slice().reverse(),function(e){if(Bridge.isBid(e)){var f=c+e,k=c+Bridge.calls[e].html;n=Bridge._generateClasses(d,["column","calls",c,e]);var m=["data-level='"+c+"'","data-bid='"+e+"'","data-call='"+f+"'"];l=Bridge._getTag(a,n);h+=Bridge._openTag(l,a,n,m);e=Bridge._generateClasses(d,["field","calls",c,e]);var q=Bridge._getTag(a,e);b[f]?e.push("enabled"):(e.push("disabled"),m.push("disabled"));h+=Bridge._openTag(q,a,e,m);h+=k;h+=Bridge._closeTag(q);
h+=Bridge._closeTag(l)}},this);h+=Bridge._closeTag(f)},this);var k="",e=Bridge._generateClasses(d,["row","utilities"]),f=Bridge._getTag(a,e),k=k+Bridge._openTag(f,a,e,[]),n=[],l="",e=[{field:"allpass",text:"All Pass",call:"allpass",bid:"p"},{field:"skip"},{field:"undo",text:"Undo",call:"undo",bid:"u"},{field:"skip"},{field:"reset",text:"Reset",call:"reset",bid:"u"}];_.each(e,function(c){n=Bridge._generateClasses(d,["column","calls",c.field]);l=Bridge._getTag(a,n);var e=["data-bid='"+c.call+"'","data-call='"+
c.call+"'"];if(a.show[c.field]&&"skip"!==c.field){k+=Bridge._openTag(l,a,n,e);var f=Bridge._generateClasses(d,["field","calls",c.field]),h=Bridge._getTag(a,f);b[c.bid]?f.push("enabled"):(f.push("disabled"),e.push("disabled"));k+=Bridge._openTag(h,a,f,e);k+=c.text;k+=Bridge._closeTag(h)}else k+="<"+l+"/>";k+=Bridge._closeTag(l)},this);k+=Bridge._closeTag(f);return Bridge._generateHTMLModule(a,c,h,k)};
